...
void sha256_process_arm(uint32_t* state, const uint8_t** data, uint32_t num)
{
    ...
    while (num >= 2)
    {
        ...
        /* Load message */
        MSG0 = vld1q_u32((const uint32_t *)(data[0] +  0));
        MSG1 = vld1q_u32((const uint32_t *)(data[0] + 16));
        MSG2 = vld1q_u32((const uint32_t *)(data[1] + 0));
        MSG3 = vld1q_u32((const uint32_t *)(data[1] + 16));
