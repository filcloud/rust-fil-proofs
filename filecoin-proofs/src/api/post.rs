...
pub fn generate_winning_post_with_proofs<Tree: 'static + MerkleTreeTrait>(
    ...
    let proof = fallback::FallbackPoStCompound::<Tree>::prove_with_proofs(
        &pub_params,
        &pub_inputs,
        &priv_inputs,
        &groth_params,
...
pub fn generate_window_post<Tree: 'static + MerkleTreeTrait>(
    ...
    generate_window_post_with_proofs(post_config, randomness, replicas, prover_id, None)
}

pub fn generate_window_post_with_proofs<Tree: 'static + MerkleTreeTrait>(
    post_config: &PoStConfig,
    randomness: &ChallengeSeed,
    replicas: &BTreeMap<SectorId, PrivateReplicaInfo<Tree>>,
    prover_id: ProverId,
    ...
    let proof = fallback::FallbackPoStCompound::prove_with_proofs(
        &pub_params,
        &pub_inputs,
        &priv_inputs,
        &groth_params,
